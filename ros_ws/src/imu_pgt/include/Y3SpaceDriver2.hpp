...
//#include <std_msgs/msgs/float64.hpp>
...
class Y3SpaceDriver : public rclcpp::Node
{
public:
    //!
    //! Constructor
    //!
    Y3SpaceDriver( std::string port, int baudrate, int timeout, std::string mode, std::string frame);
    //!
    //! Destructor
    //!
    ~Y3SpaceDriver();
