...
docker run -it --rm --net=host --device=/dev/ttyVESC --device=/dev/ttyIMU --device=/dev/video0 --device=/dev/gpiochip0 --device=/dev/gpiochip1 --device=/dev/gpiochip2 -v /dev/shm:/dev/shm -v ~/496:/496 avc/devel
